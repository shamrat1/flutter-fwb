...
class OrderDetails extends StatefulWidget {
  OrderDetails({Key? key, required this.order, this.viewer = Viewer.USER})
      : super(key: key);
...
class _OrderDetailsState extends State<OrderDetails> {
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Divider(),
                  _getSingleSummeryItem(
                      "Subtotal", data["subtotal"].toString()),
                  Divider(),
                  _getSingleSummeryItem(
                      "Delivery Charge", data["delivery_charge"].toString()),
                  Divider(),
      ...
      child: Row(
        ...
        children: [
          ...
          if (orderData["status"] == "Delivered" &&
              orderData["rating_${data["product_id"]}"] == null)
            Expanded(
                child: Container(
              alignment: Alignment.bottomRight,
              child: InkWell(
                child: Text("Rate"),
                onTap: () => _showRatingBottomSheet(data["product_id"]),
              ),
            )),
        ],
      ),
  ...
  void _showRatingBottomSheet(String productID) async {
    showModalBottomSheet(
      context: context,
      builder: (context) {
